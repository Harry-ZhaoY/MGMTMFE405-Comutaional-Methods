...
table1
# Comparing with the build-in uniformly distributed random number generator, the LGM 
# method generate a uniform distribution that has similar mean and standard deviation. 
...
# find P(X>=40)
sum(q3Bino>=40)/1000
## The exact probability for P(X>= 40) = 0.00004823664. We can expect 0.048 observations
## to be greater than or equal to 40 in 44000 trials, which is close to 0. 
